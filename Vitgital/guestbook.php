...
$title = 'Guest Book';
require 'header.php';
require 'koneksi.php'; // Include koneksi database
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (submit_guestbook($name, $email, $message)) {
        // Redirect halaman ke guestbook.php dengan status sukses
        header("Location: guestbook.php?success=true");
        exit();
    } else {
        ...
        window.addEventListener('DOMContentLoaded', (event) => {
            ...
            if (statusMessage) {
                setTimeout(() => {
                    ...
                    window.location.href = 'guestbook.php'; // Refresh halaman setelah pesan disembunyikan
