        ...
        <section id="cta" class="cta">
            <div class="container" data-aos="zoom-in">
                <div class="container text-center" data-aos="zoom-in">
                    ...
                    <a class="cta-btn btn btn-primary" href="vendor.php">Daftar Sekarang</a>
                </div>
            </div>
        </section>
                                ...
                                <div class="card h-100 shadow-sm">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <button class="btn btn-success beli-btn" data-id="<?= $product['idProduk']; ?>" data-nama="<?= $product['namaProduk']; ?>" style="width: 48%;">Beli</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        // Pop-up ketika tombol "Beli" diklik
        $('.beli-btn').on('click', function() {
    var productId = $(this).data('id');
    var productName = $(this).data('nama');
    var jumlah = prompt('Masukkan jumlah produk yang akan dibeli untuk ' + productName + ':');

    if (jumlah !== null && jumlah > 0) {
        // AJAX untuk menambahkan produk ke keranjang
        $.ajax({
            url: 'addToChart.php',
            type: 'POST',
            data: {
            ...
            error: function(xhr, status, error) {
                ...
                console.log(xhr.responseText); // Log error lebih detail
